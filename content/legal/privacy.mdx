...
| Purpose          | Description                                                                                   |
| ---------------- | --------------------------------------------------------------------------------------------- |
| Provide Services | We use your information to provide the services we offer.                                     |
| Improve Platform | We analyze your information to make improvements to our platform.                             |
| Understand Usage | We study how you use our platform to gain insights and enhance user experience.               |
| Communication    | We use your information to communicate with you, including sending updates and notifications. |

## How To Contact Us

For privacy-related questions, please contact us at [privacy@dub.sh](mailto:privacy@dub.sh).